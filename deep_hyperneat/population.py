...
class Population():
    ...
    def __init__(self, key, size, elitism=1, loader=None, state=None):
        '''
    ...
    def run(self,task,goal,generations):
        '''
        ...
        while self.current_gen < generations and not reached_goal:
            ...
            report_output(self, self._loader)
            ...
            self.avg_complexity = (avg_complexities+0.0)/len(self.population)
            self.max_complexity = max(max_complexity)
            avg_complexities = 0
